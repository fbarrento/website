...
readonly class UnauthorizedEmailDomains implements ValidationRule
{
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        if (Str::contains($value, '@')) {
            [$address, $domain] = explode('@', $value, );

            if (in_array($domain, $this->unauthorizedEmailDomains)) {

                $fail('The :attribute domain is not allowed for registration.');


            }
        } else {
            $fail('The :attribute doesn\'t contain a valid email address.');
