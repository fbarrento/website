...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" href="/storage/images/francisco.webp" type="image/webp" />
    ...
    <body class="dark:bg-background-dark overscroll-none font-sans antialiased">
        @env('production')
            <!-- Google Tag Manager (noscript) -->
            <noscript>
                <iframe
                    src="https://www.googletagmanager.com/ns.html?id=GTM-TQGPB9FN"
                    height="0"
                    width="0"
        ...
        <div class="min-h-screen">
            <x-prezet.alpine>
                <div class="relative text-gray-800 antialiased dark:text-gray-400">
                    <x-prezet.alpine>
                        ...
                        >
                            <div class="mx-auto max-w-6xl px-6 lg:px-4 xl:px-4">
                                <x-prezet.header :document="[]" />
                            </div>
                        </header>

                        <main class="relative mx-auto max-w-6xl px-6 lg:px-4 xl:px-4">
                            {{ $slot }}
                        </main>
