...
<x-images-layout>
    ...
    <div class="relative flex h-full w-full items-center justify-center bg-linear-to-b from-indigo-900 to-indigo-950">
        <div class="layout mx-auto">
            <header class="mb-5">
                <div class="mb-4 inline-block rounded-full bg-white/15 px-4 py-2 tracking-widest uppercase">
                    Laravel Cloud SDK
                </div>
            ...
            <main class="my-3 flex flex-col space-y-8">
                <section class="flex flex-col space-y-6">
                    @foreach ($layers as $layer)
                        <div class="rounded-4xl bg-white/10 p-8">
                            <p class="layer-label">
                                {{ $layer['label'] }}
                            </p>
                            ...
                            @if (! empty($layer['features'] ?? []))
                                <div class="feature-grid">
                                    @foreach ($layer['features'] as $feature)
                                        <div class="rounded-3xl bg-white/10 px-5 py-5">
                ...
                <section class="mt-2">
                    <h2 class="section-title">Works anywhere</h2>
                    <div class="audience-tags">
                        @foreach ($audiences as $audience)
                            <div class="inline-block rounded-full bg-white/15 px-4 py-2 tracking-widest uppercase">
                                {{ $audience }}
                            </div>
                        @endforeach
                    </div>
